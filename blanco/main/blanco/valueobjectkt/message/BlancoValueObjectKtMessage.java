...
public class BlancoValueObjectKtMessage {
    ...
    /**
     * Gets the string of message definition ID [BlancoValueObjectKt] and key [MBVOJI01].
     *
     * No.2:
    ...
    /**
     * Gets the string of message definition ID [BlancoValueObjectKt] and key [MBVOJI02].
     *
     * No.3:
    ...
    /**
     * Gets the string of message definition ID [BlancoValueObjectKt] and key [MBVOJI03].
     *
     * No.4:
    ...
    /**
     * Gets the string of message definition ID [BlancoValueObjectKt] and key [MBVOJI04].
     *
     * No.5:
    ...
    /**
     * Gets the string of message definition ID [BlancoValueObjectKt] and key [MBVOJI05].
     *
     * No.6:
    ...
    /**
     * Gets the string of message definition ID [BlancoValueObjectKt] and key [MBVOJI06].
     *
     * No.7:
    ...
    /**
     * Gets the string of message definition ID [BlancoValueObjectKt] and key [MBVOJI07].
     *
     * No.8:
    ...
    /**
     * Gets the string of message definition ID [BlancoValueObjectKt] and key [MBVOJI08].
     *
     * No.9:
