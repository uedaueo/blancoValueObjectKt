...
/**
 * blancoValueObjectKtが利用するメッセージ。
 */
public class BlancoValueObjectKtMessage {
    /**
     * メッセージをプロパティファイル対応させるための内部的に利用するリソースバンドルクラス。
     */
    protected final BlancoValueObjectKtMessageResourceBundle fBundle = new BlancoValueObjectKtMessageResourceBundle();

    /**
     * メッセージ定義ID[BlancoValueObjectKt]、キー[MBVOJI01]の文字列を取得します。
     *
     * No.2:
     * 文字列[クラス名[{0}]のパッケージ名が指定されていません。]
     *
    ...
    /**
     * メッセージ定義ID[BlancoValueObjectKt]、キー[MBVOJI02]の文字列を取得します。
     *
     * No.3:
     * 文字列[クラス名[{0}]のフィールド[{1}]の型名が指定されていません。]
     *
     * @param arg0 置換文字列{0}の値。
    ...
    /**
     * メッセージ定義ID[BlancoValueObjectKt]、キー[MBVOJI03]の文字列を取得します。
     *
     * No.4:
     * 文字列[クラス名[{0}] でフィールド名が指定されていないものがあります。]
     *
     * @param arg0 置換文字列{0}の値。
     * @return メッセージ文字列。
     */
    ...
    /**
     * メッセージ定義ID[BlancoValueObjectKt]、キー[MBVOJI04]の文字列を取得します。
     *
     * No.5:
     * 文字列[クラス名[{0}] フィールド[{1}]の「型」が指定されていません。「型」を指定してください。]
     *
     * @param arg0 置換文字列{0}の値。
     * @param arg1 置換文字列{1}の値。
     * @return メッセージ文字列。
    ...
    /**
     * メッセージ定義ID[BlancoValueObjectKt]、キー[MBVOJI05]の文字列を取得します。
     *
     * No.6:
     * 文字列[クラス名[{0}] フィールド[{1}]の「デフォルト値({2})」がセットされています。しかし「{3}」はデフォルト値をサポートしません。]
     *
     * @param arg0 置換文字列{0}の値。
     * @param arg1 置換文字列{1}の値。
    ...
    /**
     * メッセージ定義ID[BlancoValueObjectKt]、キー[MBVOJI06]の文字列を取得します。
     *
     * No.7:
    ...
    /**
     * メッセージ定義ID[BlancoValueObjectKt]、キー[MBVOJI07]の文字列を取得します。
     *
     * No.8:
     * 文字列[クラス名[{0}] kotlinではdata修飾子とabstract修飾子は同時に指定できません。]
     *
     * @param arg0 置換文字列{0}の値。
     * @return メッセージ文字列。
     */
    ...
    /**
     * メッセージ定義ID[BlancoValueObjectKt]、キー[MBVOJI08]の文字列を取得します。
     *
     * No.9:
     * 文字列[クラス名[{0}] フィールド[{1}]にデフォルト値が設定されていません。]
     *
     * @param arg0 置換文字列{0}の値。
     * @param arg1 置換文字列{1}の値。
     * @return メッセージ文字列。
