package blanco.valueobjectkt.message;
...
/**
 * A resource bundle class used internally by the message definition [BlancoValueObjectKt].
 *
 * リソースバンドル定義: [BlancoValueObjectKtMessage]。<BR>
 * このクラスはリソースバンドル定義書から自動生成されたリソースバンドルクラスです。<BR>
 */
class BlancoValueObjectKtMessageResourceBundle {
    /**
     * リソースバンドルオブジェクト。
     *
    ...
    /**
     * BlancoValueObjectKtMessageResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoValueObjectKtMessage]、デフォルトのロケール、呼び出し側のクラスローダを使用して、リソースバンドルを取得します。
     */
    public BlancoValueObjectKtMessageResourceBundle() {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/valueobjectkt/message/BlancoValueObjectKtMessage");
     ...
     * BlancoValueObjectKtMessageResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoValueObjectKtMessage]、指定されたロケール、呼び出し側のクラスローダを使用して、リソースバンドルを取得します。
     *
     * @param locale ロケールの指定
     */
    public BlancoValueObjectKtMessageResourceBundle(final Locale locale) {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/valueobjectkt/message/BlancoValueObjectKtMessage", locale);
        } catch (MissingResourceException ex) {
        }
    }
     ...
     * BlancoValueObjectKtMessageResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoValueObjectKtMessage]、指定されたロケール、指定されたクラスローダを使用して、リソースバンドルを取得します。
     *
     * @param locale ロケールの指定
     * @param loader クラスローダの指定
     */
    public BlancoValueObjectKtMessageResourceBundle(final Locale locale, final ClassLoader loader) {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/valueobjectkt/message/BlancoValueObjectKtMessage", locale, loader);
        } catch (MissingResourceException ex) {
        }
    }
    ...
    /**
     * bundle[BlancoValueObjectKtMessage], key[MBVOJI01]
     *
    ...
    /**
     * bundle[BlancoValueObjectKtMessage], key[MBVOJI02]
     *
    ...
    /**
     * bundle[BlancoValueObjectKtMessage], key[MBVOJI03]
     *
    ...
    /**
     * bundle[BlancoValueObjectKtMessage], key[MBVOJI04]
     *
    ...
    /**
     * bundle[BlancoValueObjectKtMessage], key[MBVOJI05]
     *
    ...
    /**
     * bundle[BlancoValueObjectKtMessage], key[MBVOJI06]
     *
    ...
    /**
     * bundle[BlancoValueObjectKtMessage], key[MBVOJI07]
     *
    ...
    /**
     * bundle[BlancoValueObjectKtMessage], key[MBVOJI08]
     *
