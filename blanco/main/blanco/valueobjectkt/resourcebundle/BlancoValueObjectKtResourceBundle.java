package blanco.valueobjectkt.resourcebundle;
...
/**
 * blancoValueObjectKtが利用するリソースバンドルを蓄えます。
 *
 * リソースバンドル定義: [BlancoValueObjectKt]。<BR>
 ...
 * </UL>
 */
public class BlancoValueObjectKtResourceBundle {
    /**
     * リソースバンドルオブジェクト。
     *
    ...
    /**
     * BlancoValueObjectKtResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoValueObjectKt]、デフォルトのロケール、呼び出し側のクラスローダを使用して、リソースバンドルを取得します。
     */
    public BlancoValueObjectKtResourceBundle() {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/valueobjectkt/resourcebundle/BlancoValueObjectKt");
     ...
     * BlancoValueObjectKtResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoValueObjectKt]、指定されたロケール、呼び出し側のクラスローダを使用して、リソースバンドルを取得します。
     *
     * @param locale ロケールの指定
     */
    public BlancoValueObjectKtResourceBundle(final Locale locale) {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/valueobjectkt/resourcebundle/BlancoValueObjectKt", locale);
        } catch (MissingResourceException ex) {
        }
    }
     ...
     * BlancoValueObjectKtResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoValueObjectKt]、指定されたロケール、指定されたクラスローダを使用して、リソースバンドルを取得します。
     *
     * @param locale ロケールの指定
     * @param loader クラスローダの指定
     */
    public BlancoValueObjectKtResourceBundle(final Locale locale, final ClassLoader loader) {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/valueobjectkt/resourcebundle/BlancoValueObjectKt", locale, loader);
        } catch (MissingResourceException ex) {
        }
    }
    ...
    /**
     * bundle[BlancoValueObjectKt], key[METAFILE_DISPLAYNAME]
     *
     * [バリューオブジェクト定義書] (ja)<br>
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[META2XML.ELEMENT_COMMON]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[META2XML.ELEMENT_LIST]
     *
     * [blancovalueobjectkt-list] (ja)<br>
     *
     * @return key[META2XML.ELEMENT_LIST]に対応する値。外部から読み込みができない場合には、定義書の値を戻します。必ずnull以外の値が戻ります。
     */
    public String getMeta2xmlElementList() {
        // 初期値として定義書の値を利用します。
        String strFormat = "blancovalueobjectkt-list";
        try {
            if (fResourceBundle != null) {
    ...
    /**
     * bundle[BlancoValueObjectKt], key[META2XML.ELEMENT_EXTENDS]
     *
     * [blancovalueobjectkt-extends] (ja)<br>
     *
    ...
    public String getMeta2xmlElementExtends() {
        // 初期値として定義書の値を利用します。
        String strFormat = "blancovalueobjectkt-extends";
        try {
            if (fResourceBundle != null) {
    ...
    /**
     * bundle[BlancoValueObjectKt], key[META2XML.ELEMENT_IMPLEMENTS]
     *
     * [blancovalueobjectkt-implements] (ja)<br>
     *
    ...
    public String getMeta2xmlElementImplements() {
        // 初期値として定義書の値を利用します。
        String strFormat = "blancovalueobjectkt-implements";
        try {
            if (fResourceBundle != null) {
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2JAVACLASS.FIELD.NAME]
     *
     * [フィールド: [{0}]。] (ja)<br>
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2JAVACLASS.FIELD.DEFAULT]
     *
     * [デフォルト: [{0}]。] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2JAVACLASS.SET.JAVADOC.01]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2JAVACLASS.SET.JAVADOC.02]
     *
     * [フィールドの説明: [{0}]。] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2JAVACLASS.SET.ARG.JAVADOC]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2JAVACLASS.GET.JAVADOC.01]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2JAVACLASS.GET.JAVADOC.02]
     *
     * [フィールドの説明: [{0}]。] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2JAVACLASS.GET.DEFAULT.JAVADOC]
     *
     * [デフォルト: [{0}]。] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2JAVACLASS.GET.RETURN.JAVADOC]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.ERR001]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.ERR002]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.ERR003]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.ERR004]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.ERR005]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.ERR006]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.FIELD.TYPE]
     *
     * [項目の型 [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.FIELD.DEFAULT]
     *
     * [規定値   [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.SET.LANGDOC.01]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.SET.LANGDOC.02]
     *
     * [項目の型 [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.SET.ARG.LANGDOC]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.GET.LANGDOC.01]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.GET.LANGDOC.02]
     *
     * [項目の型 [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.GET.ARG.LANGDOC]
     *
     * [規定値   [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.GET.RETURN.LANGDOC]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.TYPE.LANGDOC.01]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.TYPE.LANGDOC.02]
     *
     * [項目の型 [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.TYPE.ARG.LANGDOC]
     *
     * [規定値   [{0}]] (ja)<br>
     *
     * @param arg0 置換文字列{0}を置換する値。java.lang.String型を与えてください。
    ...
    /**
     * bundle[BlancoValueObjectKt], key[XML2SOURCE_FILE.TYPE.RETURN.LANGDOC]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[ANTTASK.ERR001]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[META2XML.ELEMENT_COMMON_CS]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[META2XML.ELEMENT_COMMON_JS]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[META2XML.ELEMENT_COMMON_VB]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[META2XML.ELEMENT_COMMON_PHP]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[META2XML.ELEMENT_COMMON_RUBY]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[META2XML.ELEMENT_COMMON_PYTHON]
     *
    ...
    /**
     * bundle[BlancoValueObjectKt], key[META2XML.ELEMENT_COMMON_KT]
     *
     * [blancovalueobjectkt-common] (ja)<br>
     *
